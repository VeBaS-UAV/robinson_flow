...
from PyQt5.QtWidgets import QPushButton, QComboBox, QSlider, QTextEdit, QPlainTextEdit, QWidget, QVBoxLayout, QLineEdit


class ButtonNode_MainWidget(MWB, QPushButton):
